...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Modifica Registro Medico</h4>
        <h6 class="card-subtitle">Preparatoria Mano Amiga Lerma</h6>
		<form action ="{{route('editaregmedico')}}" class="form p-t-20" method='POST' enctype='multipart/form-data'>
			{{csrf_field()}}
			<div class="row">
                <div class="col-lg-6">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-key"></i></div>
			 					<input type = 'text' class="form-control" name = 'idrm' value="{{$rmedicos->idrm}}" readonly="readonly">
						</div>
                    </div>
				</div>
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-user"></i></div>
								<input type ='text' class="form-control" name = 'responsable' value="{{$rmedicos->responsable}}" >
						</div>
                    </div>
				</div>
			</div>
			...
			<div class="row">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-money"></i></div>
				 				<input type = 'text' class="form-control" name = 'num_hermanos' value="{{$rmedicos->num_hermanos}}">
						</div>
                    </div>
				</div>
				...
				<div class="col-lg-6">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-user"></i></div>
								<input type ='text' class="form-control" name = 'nom_hermanos' value="{{$rmedicos->nom_hermanos}}">
						</div>
                    </div>
				</div>
			</div>
			...
			<div class="row">
                <div class="col-lg-6">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-user"></i></div>
								<input type ='text' class="form-control" name ='edad' value="{{$rmedicos->edad}}">
						</div>
                    </div>
				</div>
				...
				<div class="col-lg-6">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-user"></i></div>
								<input type ='text' class="form-control" name ='tipo_sangre' value="{{$rmedicos->tipo_sangre}}">
						</div>
                    </div>
				</div>
			</div>
			...
			<div class="row">
                <div class="col-lg-6">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-user"></i></div>
								<input type ='text' class="form-control" name ='contacto1' value="{{$rmedicos->contacto1}}">
						</div>
                    </div>
				</div>
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-mobile"></i></div>
								<input type ='text' class="form-control" name ='tel1' value="{{$rmedicos->tel1}}">
						</div>
                    </div>
				</div>
			</div>
			...
			<div class="row">
                <div class="col-lg-6">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-user"></i></div>
								<input type ='text' class="form-control" name ='contacto2' value="{{$rmedicos->contacto2}}">
						</div>
                    </div>
				</div>
				...
				<div class="col-lg-6">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-mobile"></i></div>
								<input type ='text' class="form-control" name ='tel2' value="{{$rmedicos->tel2}}">
						</div>
                    </div>
				</div>
			</div>
			...
			<div class="row">
                <div class="col-lg-6">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-user"></i></div>
								<input type ='text' class="form-control" name ='contacto3' value="{{$rmedicos->contacto3}}">
						</div>
                    </div>
				</div>
				...
				<div class="col-lg-6">	
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-mobile"></i></div>
								<input type ='text' class="form-control" name ='tel3' value="{{$rmedicos->tel3}}">
						</div>
                    </div>
				</div>
			</div>
