...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" src = "{{asset ('images/favicon.png') }}">
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img alt="homepage" class="dark-logo" src = "{{asset ('images/logo.png') }}"/></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><img alt="homepage" class="dark-logo" src = "{{asset ('images/logo-text.png') }}" /></span>
                    </a>
                </div>
                <!-- End Logo -->
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img  alt="user" class="profile-pic" src="{{ asset('images/users/5.jpg') }}"/></a>
        ...
        <div class="page-wrapper">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2018 Todos Los Derechos Reservados. Preparatoria Mano Amiga Lerma</footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
