...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Alta Empleados</h4>
        <h6 class="card-subtitle">Preparatoria Mano Amiga Lerma</h6>
		<form action ="{{route('guardaempleado')}}" class="form p-t-20" method='POST' enctype='multipart/form-data'>
			{{csrf_field()}}
			<div class="row">
                <div class="col-lg-6">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-key"></i></div>
								<input type = 'text' class="form-control" name = 'idbe' value="{{$idbe}}" readonly="readonly">
						</div>
                    </div>
				</div>
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="ti-timer"></i></div>
								<input type ='text' class="form-control" name ='turno' value="{{old('turno')}}">
						</div>
                    </div>
				</div>
